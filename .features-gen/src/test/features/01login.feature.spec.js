...
test.describe('Login Page Validation', () => {
  ...
  test.describe('Verify Admin is not able to land on home page with invalid URL - "<TestCase>"', () => {
    ...
    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_DomainName"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
    ...
    test('Verify Admin is not able to land on home page with invalid URL - "Misspelled_DomainName"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Misspelled_DomainName"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_Protocol"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Incorrect_Protocol"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_Endpoint"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Incorrect_Endpoint"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Misspelled_Endpoint"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Misspelled_Endpoint"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_TopLevelDomain"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Incorrect_TopLevelDomain"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Missing_TopLevelDomain"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Missing_TopLevelDomain"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "NonExistenSubDomain"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "NonExistenSubDomain"', null, { loginPageFixture }); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "InvalidCharacters"', { tag: ['@login'] }, async ({ When, loginPageFixture, Then }) => { 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":104,"pickleLine":84,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":105,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_DomainName\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_DomainName\"","children":[{"start":54,"value":"Incorrect_DomainName","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":106,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":109,"pickleLine":85,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":110,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Misspelled_DomainName\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Misspelled_DomainName\"","children":[{"start":54,"value":"Misspelled_DomainName","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":111,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":114,"pickleLine":86,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":115,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_Protocol\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_Protocol\"","children":[{"start":54,"value":"Incorrect_Protocol","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":116,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":119,"pickleLine":87,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":120,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_Endpoint\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_Endpoint\"","children":[{"start":54,"value":"Incorrect_Endpoint","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":121,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":124,"pickleLine":88,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":125,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Misspelled_Endpoint\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Misspelled_Endpoint\"","children":[{"start":54,"value":"Misspelled_Endpoint","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":126,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":129,"pickleLine":89,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":130,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_TopLevelDomain\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_TopLevelDomain\"","children":[{"start":54,"value":"Incorrect_TopLevelDomain","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":131,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":134,"pickleLine":90,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":135,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Missing_TopLevelDomain\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Missing_TopLevelDomain\"","children":[{"start":54,"value":"Missing_TopLevelDomain","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":136,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":139,"pickleLine":91,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":140,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"NonExistenSubDomain\"","stepMatchArguments":[{"group":{"start":53,"value":"\"NonExistenSubDomain\"","children":[{"start":54,"value":"NonExistenSubDomain","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":141,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":144,"pickleLine":92,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":145,"gherkinStepLine":79,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"InvalidCharacters\"","stepMatchArguments":[{"group":{"start":53,"value":"\"InvalidCharacters\"","children":[{"start":54,"value":"InvalidCharacters","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":146,"gherkinStepLine":80,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
]; // bdd-data-end