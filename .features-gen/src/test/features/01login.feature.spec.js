...
test.describe('Login Page Validation', () => {
  ...
  test('Validate login credentials with null password', { tag: ['@login', '@fail', '@TPL-135'] }, async ({ Given, When, Then }) => { 
    test.fail();
    await Given('Admin lands on login page'); 
  ...
  test.describe('Verify Admin is not able to land on home page with invalid URL - "<TestCase>"', () => {
    ...
    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_DomainName"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
    ...
    test('Verify Admin is not able to land on home page with invalid URL - "Misspelled_DomainName"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Misspelled_DomainName"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_Protocol"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Incorrect_Protocol"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_Endpoint"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Incorrect_Endpoint"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Misspelled_Endpoint"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Misspelled_Endpoint"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Incorrect_TopLevelDomain"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Incorrect_TopLevelDomain"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "Missing_TopLevelDomain"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "Missing_TopLevelDomain"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "NonExistenSubDomain"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
      await When('Admin gives the invalid LMS portal URL for test case "NonExistenSubDomain"'); 
      await Then('Admin should receive application error'); 
    });

    test('Verify Admin is not able to land on home page with invalid URL - "InvalidCharacters"', { tag: ['@login', '@TPL-143'] }, async ({ When, Then }) => { 
  ...
  test('Verify input descriptive text in user field', { tag: ['@login', '@TPL-136'] }, async ({ Then }) => { 
    await Then('Admin should see user in gray color'); 
  });

  test('Verify input descriptive text in password field', { tag: ['@login', '@TPL-136'] }, async ({ Then }) => { 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":72,"pickleLine":45,"tags":["@login","@fail","@TPL-135"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":74,"gherkinStepLine":46,"keywordType":"Context","textWithKeyword":"Given Admin lands on login page","stepMatchArguments":[]},{"pwStepLine":75,"gherkinStepLine":47,"keywordType":"Action","textWithKeyword":"When Admin enter value only in user name and clicks login button","stepMatchArguments":[]},{"pwStepLine":76,"gherkinStepLine":48,"keywordType":"Outcome","textWithKeyword":"Then Error message \"Please enter your password\"","stepMatchArguments":[{"group":{"start":14,"value":"\"Please enter your password\"","children":[{"start":15,"value":"Please enter your password","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":79,"pickleLine":52,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":80,"gherkinStepLine":53,"keywordType":"Context","textWithKeyword":"Given Admin lands on login page","stepMatchArguments":[]},{"pwStepLine":81,"gherkinStepLine":54,"keywordType":"Action","textWithKeyword":"When Admin does not enter credentials and clicks on login button","stepMatchArguments":[]},{"pwStepLine":82,"gherkinStepLine":55,"keywordType":"Outcome","textWithKeyword":"Then Admin sees 2 error messages \"Please enter your user name\" and \"Please enter your password\"","stepMatchArguments":[{"group":{"start":11,"value":"2","children":[]},"parameterTypeName":"int"},{"group":{"start":28,"value":"\"Please enter your user name\"","children":[{"start":29,"value":"Please enter your user name","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":62,"value":"\"Please enter your password\"","children":[{"start":63,"value":"Please enter your password","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":85,"pickleLine":60,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":86,"gherkinStepLine":61,"keywordType":"Context","textWithKeyword":"Given Admin lands on login page","stepMatchArguments":[]},{"pwStepLine":87,"gherkinStepLine":62,"keywordType":"Outcome","textWithKeyword":"Then Admin should see \"Please login to LMS application\"","stepMatchArguments":[{"group":{"start":17,"value":"\"Please login to LMS application\"","children":[{"start":18,"value":"Please login to LMS application","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":90,"pickleLine":64,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":91,"gherkinStepLine":65,"keywordType":"Outcome","textWithKeyword":"Then If HTTP response >= 400, then the link is broken","stepMatchArguments":[{"group":{"start":20,"value":"400","children":[]},"parameterTypeName":"int"}]}]},
  {"pwTestLine":94,"pickleLine":71,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":95,"gherkinStepLine":72,"keywordType":"Outcome","textWithKeyword":"Then Admin should see  LMS - Learning Management System","stepMatchArguments":[]}]},
  ...
  {"pwTestLine":104,"pickleLine":85,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":105,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_DomainName\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_DomainName\"","children":[{"start":54,"value":"Incorrect_DomainName","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":106,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":109,"pickleLine":86,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":110,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Misspelled_DomainName\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Misspelled_DomainName\"","children":[{"start":54,"value":"Misspelled_DomainName","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":111,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":114,"pickleLine":87,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":115,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_Protocol\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_Protocol\"","children":[{"start":54,"value":"Incorrect_Protocol","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":116,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":119,"pickleLine":88,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":120,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_Endpoint\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_Endpoint\"","children":[{"start":54,"value":"Incorrect_Endpoint","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":121,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":124,"pickleLine":89,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":125,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Misspelled_Endpoint\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Misspelled_Endpoint\"","children":[{"start":54,"value":"Misspelled_Endpoint","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":126,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":129,"pickleLine":90,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":130,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Incorrect_TopLevelDomain\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Incorrect_TopLevelDomain\"","children":[{"start":54,"value":"Incorrect_TopLevelDomain","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":131,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":134,"pickleLine":91,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":135,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"Missing_TopLevelDomain\"","stepMatchArguments":[{"group":{"start":53,"value":"\"Missing_TopLevelDomain\"","children":[{"start":54,"value":"Missing_TopLevelDomain","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":136,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":139,"pickleLine":92,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":140,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"NonExistenSubDomain\"","stepMatchArguments":[{"group":{"start":53,"value":"\"NonExistenSubDomain\"","children":[{"start":54,"value":"NonExistenSubDomain","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":141,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":144,"pickleLine":93,"tags":["@login","@TPL-143"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":145,"gherkinStepLine":80,"keywordType":"Action","textWithKeyword":"When Admin gives the invalid LMS portal URL for test case \"InvalidCharacters\"","stepMatchArguments":[{"group":{"start":53,"value":"\"InvalidCharacters\"","children":[{"start":54,"value":"InvalidCharacters","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":146,"gherkinStepLine":81,"keywordType":"Outcome","textWithKeyword":"Then Admin should receive application error","stepMatchArguments":[]}]},
  {"pwTestLine":151,"pickleLine":97,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":152,"gherkinStepLine":98,"keywordType":"Outcome","textWithKeyword":"Then Admin should see 2 text field","stepMatchArguments":[{"group":{"start":17,"value":"2","children":[]},"parameterTypeName":"int"}]}]},
  {"pwTestLine":155,"pickleLine":100,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":156,"gherkinStepLine":101,"keywordType":"Outcome","textWithKeyword":"Then Admin should \"User\" in the first text field","stepMatchArguments":[{"group":{"start":13,"value":"\"User\"","children":[{"start":14,"value":"User","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":159,"pickleLine":103,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":160,"gherkinStepLine":104,"keywordType":"Outcome","textWithKeyword":"Then Admin should see asterisk mark symbol next to text for mandatory fields","stepMatchArguments":[]}]},
  {"pwTestLine":163,"pickleLine":107,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":164,"gherkinStepLine":108,"keywordType":"Outcome","textWithKeyword":"Then Admin should \"Password\" in the second text field","stepMatchArguments":[{"group":{"start":13,"value":"\"Password\"","children":[{"start":14,"value":"Password","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":167,"pickleLine":110,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":168,"gherkinStepLine":111,"keywordType":"Outcome","textWithKeyword":"Then Admin should see asterisk mark symbol next to password text","stepMatchArguments":[]}]},
  {"pwTestLine":171,"pickleLine":114,"tags":["@login","@wip","@failing"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":172,"gherkinStepLine":115,"keywordType":"Outcome","textWithKeyword":"Then Admin should see input field on the centre of the page","stepMatchArguments":[]}]},
  {"pwTestLine":175,"pickleLine":119,"tags":["@login"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":176,"gherkinStepLine":120,"keywordType":"Outcome","textWithKeyword":"Then Admin should see login button","stepMatchArguments":[]}]},
  {"pwTestLine":179,"pickleLine":123,"tags":["@login","@TPL-136"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":180,"gherkinStepLine":124,"keywordType":"Outcome","textWithKeyword":"Then Admin should see user in gray color","stepMatchArguments":[]}]},
  {"pwTestLine":183,"pickleLine":126,"tags":["@login","@TPL-136"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given The browser is open","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And Admin gives the correct LMS portal URL","isBg":true,"stepMatchArguments":[]},{"pwStepLine":184,"gherkinStepLine":127,"keywordType":"Outcome","textWithKeyword":"Then Admin should see password in gray color","stepMatchArguments":[]}]},
]; // bdd-data-end