...
test.describe('Validate class page functionality', () => {
  ...
  test('Validate multiple class delete button by selecting multiple checkboxes and clicking YES', { tag: ['@parallel'] }, async ({ Given, classPageFixture, When, Then, And }) => { 
    await Given('Admin clicks multiple checkbox in the data table and clicks Multi Delete icon in class page', null, { classPageFixture }); 
    await When('Admin clicks Yes option to delete on confirm page of class', null, { classPageFixture }); 
    await Then('Admin gets a message Successful Classes Deleted alert', null, { classPageFixture }); 
    await And('Do not see that Classes in the data table', null, { classPageFixture }); 
  });
  ...
  test.describe('Class Page Pagination', () => {

    test('Example #1', { tag: ['@parallel'] }, async ({ Then, classPageFixture }) => { 
      await Then('Admin navigated to the respective pages when he clicks the "next" link on the data table in Class module', null, { classPageFixture }); 
    });

    test('Example #2', { tag: ['@parallel'] }, async ({ Then, classPageFixture }) => { 
      await Then('Admin navigated to the respective pages when he clicks the "previous" link on the data table in Class module', null, { classPageFixture }); 
    });

    test('Example #3', { tag: ['@parallel'] }, async ({ Then, classPageFixture }) => { 
      await Then('Admin navigated to the respective pages when he clicks the "first" link on the data table in Class module', null, { classPageFixture }); 
    });

    test('Example #4', { tag: ['@parallel'] }, async ({ Then, classPageFixture }) => { 
      await Then('Admin navigated to the respective pages when he clicks the "last" link on the data table in Class module', null, { classPageFixture }); 
    });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":310,"pickleLine":173,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":311,"gherkinStepLine":174,"keywordType":"Context","textWithKeyword":"Given Admin clicks multiple checkbox in the data table and clicks Multi Delete icon in class page","stepMatchArguments":[]},{"pwStepLine":312,"gherkinStepLine":175,"keywordType":"Action","textWithKeyword":"When Admin clicks Yes option to delete on confirm page of class","stepMatchArguments":[]},{"pwStepLine":313,"gherkinStepLine":176,"keywordType":"Outcome","textWithKeyword":"Then Admin gets a message Successful Classes Deleted alert","stepMatchArguments":[]},{"pwStepLine":314,"gherkinStepLine":177,"keywordType":"Outcome","textWithKeyword":"And Do not see that Classes in the data table","stepMatchArguments":[]}]},
  {"pwTestLine":319,"pickleLine":187,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":320,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"batchName_AscendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"batchName_AscendingOrder\"","children":[{"start":153,"value":"batchName_AscendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":323,"pickleLine":188,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":324,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"batchName_DescendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"batchName_DescendingOrder\"","children":[{"start":153,"value":"batchName_DescendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":327,"pickleLine":189,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":328,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"classTopic_AscendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"classTopic_AscendingOrder\"","children":[{"start":153,"value":"classTopic_AscendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":331,"pickleLine":190,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":332,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"classTopic_DecendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"classTopic_DecendingOrder\"","children":[{"start":153,"value":"classTopic_DecendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":335,"pickleLine":191,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":336,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"ClassDescription_AscendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"ClassDescription_AscendingOrder\"","children":[{"start":153,"value":"ClassDescription_AscendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":339,"pickleLine":192,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":340,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"ClassDescription_DescendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"ClassDescription_DescendingOrder\"","children":[{"start":153,"value":"ClassDescription_DescendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":343,"pickleLine":193,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":344,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"staffName_AscendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"staffName_AscendingOrder\"","children":[{"start":153,"value":"staffName_AscendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":347,"pickleLine":194,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":348,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then Admin see the Class Topic/Batch Name/Class Description / Staff Name and Class Dates sorted by ascending or decending order after clicking the sort icon \"staffName_DecendingOrder\"","stepMatchArguments":[{"group":{"start":152,"value":"\"staffName_DecendingOrder\"","children":[{"start":153,"value":"staffName_DecendingOrder","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":355,"pickleLine":202,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":356,"gherkinStepLine":199,"keywordType":"Action","textWithKeyword":"When Admin searches by below scenario \"searchBy_batchName\" in the Class module","stepMatchArguments":[{"group":{"start":33,"value":"\"searchBy_batchName\"","children":[{"start":34,"value":"searchBy_batchName","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":359,"pickleLine":203,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":360,"gherkinStepLine":199,"keywordType":"Action","textWithKeyword":"When Admin searches by below scenario \"searchBy_classTopic\" in the Class module","stepMatchArguments":[{"group":{"start":33,"value":"\"searchBy_classTopic\"","children":[{"start":34,"value":"searchBy_classTopic","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":363,"pickleLine":204,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":364,"gherkinStepLine":199,"keywordType":"Action","textWithKeyword":"When Admin searches by below scenario \"searchBy_ClassDescription\" in the Class module","stepMatchArguments":[{"group":{"start":33,"value":"\"searchBy_ClassDescription\"","children":[{"start":34,"value":"searchBy_ClassDescription","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":367,"pickleLine":205,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":368,"gherkinStepLine":199,"keywordType":"Action","textWithKeyword":"When Admin searches by below scenario \"searchBy_staffName\" in the Class module","stepMatchArguments":[{"group":{"start":33,"value":"\"searchBy_staffName\"","children":[{"start":34,"value":"searchBy_staffName","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":375,"pickleLine":214,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":376,"gherkinStepLine":211,"keywordType":"Outcome","textWithKeyword":"Then Admin navigated to the respective pages when he clicks the \"next\" link on the data table in Class module","stepMatchArguments":[{"group":{"start":59,"value":"\"next\"","children":[{"start":60,"value":"next","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":379,"pickleLine":215,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":380,"gherkinStepLine":211,"keywordType":"Outcome","textWithKeyword":"Then Admin navigated to the respective pages when he clicks the \"previous\" link on the data table in Class module","stepMatchArguments":[{"group":{"start":59,"value":"\"previous\"","children":[{"start":60,"value":"previous","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":383,"pickleLine":216,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":384,"gherkinStepLine":211,"keywordType":"Outcome","textWithKeyword":"Then Admin navigated to the respective pages when he clicks the \"first\" link on the data table in Class module","stepMatchArguments":[{"group":{"start":59,"value":"\"first\"","children":[{"start":60,"value":"first","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":387,"pickleLine":217,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":388,"gherkinStepLine":211,"keywordType":"Outcome","textWithKeyword":"Then Admin navigated to the respective pages when he clicks the \"last\" link on the data table in Class module","stepMatchArguments":[{"group":{"start":59,"value":"\"last\"","children":[{"start":60,"value":"last","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end