...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":267,"pickleLine":133,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":268,"gherkinStepLine":134,"keywordType":"Action","textWithKeyword":"When Admin clicks the delete icon in the class page of a class topic","stepMatchArguments":[]},{"pwStepLine":269,"gherkinStepLine":135,"keywordType":"Action","textWithKeyword":"And Admin clicks No option to delete on confirm page of class","stepMatchArguments":[]},{"pwStepLine":270,"gherkinStepLine":136,"keywordType":"Outcome","textWithKeyword":"Then Admin can see the deletion alert disappears without deleting the class","stepMatchArguments":[]}]},
  {"pwTestLine":273,"pickleLine":138,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":274,"gherkinStepLine":139,"keywordType":"Action","textWithKeyword":"When Admin clicks the delete icon in the class page of a class topic","stepMatchArguments":[]},{"pwStepLine":275,"gherkinStepLine":140,"keywordType":"Action","textWithKeyword":"And Admin clicks Yes option to delete on confirm page of class","stepMatchArguments":[]},{"pwStepLine":276,"gherkinStepLine":141,"keywordType":"Outcome","textWithKeyword":"Then Admin gets a message Successful Class Deleted alert","stepMatchArguments":[]},{"pwStepLine":277,"gherkinStepLine":142,"keywordType":"Outcome","textWithKeyword":"And Do not see that Class in the data table","stepMatchArguments":[]}]},
  {"pwTestLine":280,"pickleLine":144,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":281,"gherkinStepLine":145,"keywordType":"Action","textWithKeyword":"When Admin clicks the delete icon in the class page of a class topic","stepMatchArguments":[]},{"pwStepLine":282,"gherkinStepLine":146,"keywordType":"Action","textWithKeyword":"And Admin clicks CLose X Icon on confirm page of class","stepMatchArguments":[]},{"pwStepLine":283,"gherkinStepLine":147,"keywordType":"Outcome","textWithKeyword":"Then Admin can see the deletion alert disappears without deleting the class","stepMatchArguments":[]}]},
  {"pwTestLine":286,"pickleLine":150,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":287,"gherkinStepLine":151,"keywordType":"Action","textWithKeyword":"When Admin clicks any checkbox in the data table","stepMatchArguments":[]},{"pwStepLine":288,"gherkinStepLine":152,"keywordType":"Outcome","textWithKeyword":"Then Admin should see common delete option enabled under header Manage class","stepMatchArguments":[]}]},
]; // bdd-data-end