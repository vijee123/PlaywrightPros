...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":273,"pickleLine":144,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":274,"gherkinStepLine":145,"keywordType":"Action","textWithKeyword":"When Admin clicks the delete icon in the class page","stepMatchArguments":[]},{"pwStepLine":275,"gherkinStepLine":146,"keywordType":"Action","textWithKeyword":"And Admin clicks CLose X Icon on confirm page of class","stepMatchArguments":[]},{"pwStepLine":276,"gherkinStepLine":147,"keywordType":"Outcome","textWithKeyword":"Then Admin can see the deletion alert disappears without deleting the class","stepMatchArguments":[]}]},
  {"pwTestLine":279,"pickleLine":150,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":280,"gherkinStepLine":151,"keywordType":"Action","textWithKeyword":"When Admin clicks any checkbox in the data table","stepMatchArguments":[]},{"pwStepLine":281,"gherkinStepLine":152,"keywordType":"Outcome","textWithKeyword":"Then Admin should see common delete option enabled under header Manage class","stepMatchArguments":[]}]},
  {"pwTestLine":284,"pickleLine":154,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":285,"gherkinStepLine":155,"keywordType":"Context","textWithKeyword":"Given Admin clicks single checkbox in the data table and clicks Multi Delete icon in class page","stepMatchArguments":[]},{"pwStepLine":286,"gherkinStepLine":156,"keywordType":"Action","textWithKeyword":"When Admin clicks No option to delete on confirm page of class","stepMatchArguments":[]},{"pwStepLine":287,"gherkinStepLine":157,"keywordType":"Outcome","textWithKeyword":"Then Admin can see the deletion alert disappears without deleting the class","stepMatchArguments":[]}]},
  {"pwTestLine":290,"pickleLine":166,"tags":["@parallel"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Admin clicks the Class Navigation bar in the Header","isBg":true,"stepMatchArguments":[]},{"pwStepLine":291,"gherkinStepLine":167,"keywordType":"Context","textWithKeyword":"Given Admin clicks multiple checkbox in the data table and clicks Multi Delete icon in class page","stepMatchArguments":[]},{"pwStepLine":292,"gherkinStepLine":168,"keywordType":"Action","textWithKeyword":"When Admin clicks No option to delete on confirm page of class","stepMatchArguments":[]},{"pwStepLine":293,"gherkinStepLine":169,"keywordType":"Outcome","textWithKeyword":"Then Admin can see the deletion alert disappears without deleting the selected classes","stepMatchArguments":[]}]},
]; // bdd-data-end